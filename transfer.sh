...
./xaiPatch patch101_fix.xai "shift-jis_dist/patch101/script/mp1201.bin" script/mp1201.bin > /dev/null
./xaiPatch $DIR/app/PCSG00881/patch101.xai "shift-jis_dist/patch101/script/mp1201.bin" script/mp1201.bin > /dev/null
